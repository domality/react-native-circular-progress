...
export default class CircularProgress extends React.Component {
	...
	render() {
		...
		const circlePath = this.circlePath(size / 2, size / 2, size / 2 - width / 2, 0, 360 * 0.9999 * fill / 100);
			...
			<View style={style}>
				<Surface width={size} height={size}>
					<Group rotation={rotation - 90} originX={size / 2} originY={size / 2}>
						...
						<Shape d={circlePath} stroke={tintColor} strokeWidth={width} strokeCap={linecap} />
					</Group>
				</Surface>
